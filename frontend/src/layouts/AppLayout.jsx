...
import {
  ...
  CreditCard, FileCheck, Fingerprint, UserSquare, GitMerge, RefreshCw
} from 'lucide-react';
...
export default function AppLayout() {
  ...
  const menu = [
    ...
    { name: 'Indústria & PCP', path: '/app/pcp', icon: Factory },
    { name: 'Terminal Chão de Fábrica', path: '/app/pcp/terminal', icon: Monitor },
    { name: 'Compras & Suprimentos', path: '/app/compras', icon: ShoppingCart },
    { name: 'Pedidos & Vendas', path: '/app/vendas', icon: ShoppingBag },
