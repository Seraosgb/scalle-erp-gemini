...
import { Users, Plus, ShieldCheck, Mail, Phone, CheckCircle2, AlertTriangle, X } from 'lucide-react';
    ...
    <div className="space-y-5 max-w-7xl mx-auto p-3 sm:p-5 text-slate-200">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        {isLoading ? (
          ...
          usuarios.map((u) => (
            <div key={u.id} className="p-4 bg-slate-900 border border-slate-800 rounded-2xl space-y-3">
