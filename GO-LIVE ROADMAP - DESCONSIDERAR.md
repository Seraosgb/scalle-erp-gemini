...
* **Comercial, Frente de Caixa (PDV) & Financeiro:** Funil Inbound CRM, orçamentos, contas bancárias, liquidação de faturas (Contas a Pagar/Receber) e PDV Balcão (Tier 1) com interface _keyboard-first_, integração nativa de hardware via Web Serial API (balanças e impressoras térmicas ESC/POS) e baixa atômica de estoque.
...
* **Status:** Layout administrativo construído; PDV Balcão Tier 1 operacional com integração nativa de hardware em tempo real; dashboards modulares criados; roteamento e RBAC implantados no React. Faltam pequenos refinamentos de UI e PWA Offline-First para técnicos de campo.
